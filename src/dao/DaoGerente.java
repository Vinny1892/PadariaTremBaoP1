...
public class DaoGerente extends GenericDao implements CRUDBasico {
    ...
    public void salvar(Object object) throws SQLException {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao inserir gerente");
        }
    }
    ...
    public void deletar(String cpf) throws SQLException {
        delete("DELETE FROM gerente WHERE id_gerente cpf = ? ", cpf);
    }
    ...
    public Object getById(int id) throws SQLException {
        ...
        PreparedStatement stmt = getConnection().prepareStatement("SELECT  * FROM gerente WHERE id_gerente = ?");
        stmt.setInt(1, id);
